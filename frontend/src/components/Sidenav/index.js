  ...
  return (
    <SidenavRoot {...rest} variant="permanent" ownerState={{ transparentSidenav, miniSidenav }}>
      <SuiBox pt={3} pb={1} px={4} textAlign="center">
        ...
        <SuiBox component={NavLink} to="/" display="flex" alignItems="center" style={{ justifyContent: 'center' }}>
          {/* <SuiBox component="img" src={logoEmpresa} alt="Baas logo" width="100px" style={{ height: '45px' }} /> */}
          LOGO DA EMPRESA
        </SuiBox>
      </SuiBox>
      <Divider />
